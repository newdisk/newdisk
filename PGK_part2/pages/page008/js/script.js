...
'use strict';
	...
	function showAnswers(array) {
		...
		var message = ''; 
		for (var i = 0; i < array.length; i++){
			message = message + '<div style="float: left; width: 210px; height: 120px; margin-top: 5px; text-align: center" class="feedback"><span class="feedback__item">' + '<img style="display:block; margin: 0 auto" class="feedback__img" width="100" src="pages/page008/' + 
