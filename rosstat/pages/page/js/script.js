...
'use strict';
	...
	document.querySelector('.container').innerHTML = '<img src="../'+ctrl.structure.pages[ctrl.bookmark].image+'"><audio class="pageAudio" src="../'+ctrl.structure.pages[ctrl.bookmark].sound+'"></audio>';
