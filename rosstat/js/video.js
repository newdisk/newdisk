...
BigPlayButton.prototype.controlText_ = 'Воспроизвести видео';
...
var FullscreenToggle = function (_Button) {
  ...
  FullscreenToggle.prototype.handleFullscreenChange = function handleFullscreenChange(event) {
    if (this.player_.isFullscreen()) {
      this.controlText('Уменьшить размер экрана');
    } else {
      this.controlText('На весь экран');
    }
  };
...
FullscreenToggle.prototype.controlText_ = 'На весь экран';
...
var PlayToggle = function (_Button) {
  ...
  PlayToggle.prototype.handlePause = function handlePause(event) {
    ...
    this.controlText('Воспроизведение');
  };
...
PlayToggle.prototype.controlText_ = 'Воспроизведение';
